...
Next, we assign cells in the `SingleCellExperiment` object to their specific structure. This is useful for later calculations.
...
) |> st_as_sfc() |> st_as_sf() # both functions needed for proper conversion
