...
<!-- ```{r, include=FALSE, eval=FALSE} -->
<!-- islet2 <- reconstructShapeDensityImage( -->
<!--   spe, -->
<!--   marks = "cell_category", -->
<!--   image_col = "image_name", -->
<!--   image_id = "E04", -->
...
patient_data <- colData(spe) |>
  as_tibble() |>
  group_by(image_name) |>
  select(all_of(c("patient_stage",  "tissue_slide", "tissue_region",
