...
In this vignette we will use a dataset containing imaging mass cytometry (IMC) data of pancreatic islets of human donors at different stages of type 1 diabetes (T1D) and healthy controls [@damondMapHumanType2019]. Note that we will only use a subset of the patients.

```{r loading, echo=FALSE, message=FALSE}
# load experiment hub
eh <- ExperimentHub()
objectId <- names(eh[eh$title == "Damond_2019_Pancreas - sce - v1 - full"])
